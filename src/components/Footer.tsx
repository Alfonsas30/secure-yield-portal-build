      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="p-6 bg-slate-800 rounded-lg border border-slate-700 h-full">
              <h3 className="font-semibold text-white text-lg mb-4">{t('footer.contact.title')}</h3>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-2">{t('footer.contact.messengers')}</p>
                </div>
                <div>
          ...
          <div>
            <div className="p-6 bg-slate-800 rounded-lg border border-slate-700 h-full">
              <h3 className="font-semibold text-white text-lg mb-4">{t('footer.techSupport.title')}</h3>
              <div className="space-y-4">
                <div>
                ...
                <div>
                  <p className="text-sm text-slate-300 mb-2">{t('footer.techSupport.email')}</p>
                  <a 
