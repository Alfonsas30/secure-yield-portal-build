    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
      <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200">
        <CardContent className="p-8 text-center">
          ...
          <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 text-slate-900 uppercase tracking-wide">MOKĖSITE KAS MĖNESĮ:</h3>
          <p className="text-3xl md:text-4xl lg:text-5xl font-black text-blue-600 mb-3 md:mb-4 drop-shadow-lg">
