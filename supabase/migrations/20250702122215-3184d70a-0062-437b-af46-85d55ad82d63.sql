-- Fix the discount request trigger - ensure it's AFTER and working properly
-- Step 1: Clean up any existing trigger
...
-- Step 3: Create the corrected function with better error handling and logging
...
BEGIN
    ...
    RAISE NOTICE 'Discount request trigger fired for email: %', NEW.email;
    ...
    RAISE NOTICE 'Webhook payload: %', payload;
...
-- Step 4: Create the AFTER trigger (not BEFORE)
